	...
	else
	{
		...
		if (empty($_POST['login']) || empty($_POST['mdp']) ) //Oublie d'un champ
		{
			$message = '<div class="alert alert-danger" role="alert">
							...
							<br /><a class="label label-default" href="index.php">Cliquez ici pour revenir à la page de connexion</a>
						</div>';
		}
		else //On check le mot de passe
		{
			$query=$db->prepare('SELECT user_mdp, user_id, user_login
								 FROM user WHERE user_login = :login');
